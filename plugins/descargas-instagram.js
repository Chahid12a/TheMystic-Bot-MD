...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  if (!args[0]) throw `_*< التحميلات - INSTAGRAM />*_\n\n*[ ℹ️ ] أدخل رابط الانستقرام.*\n\n*[ 💡 ] متال:* _${usedPrefix + command} https://www.instagram.com/reel/xxxxxR/?utm_source=ig_web_copy_link_`;
  m.reply(global.wait);
  try {
...
for (let i = 0; i < img.length; i++) {
  ...
  try {
    ...
    for (const urRRl of datTa) {
      ...
      const tXXxt = `_*< التحميلات - INSTAGRAM />*_\n\n▢ *URL:* _${shortUrRRl}_`.trim();
